...
$sql1 = "SELECT ROUND(AVG(REQ_timings)) AS MX, DATE_FORMAT(REQ_startedDateTime,'%W') AS d, HOUR(DATE_FORMAT(`REQ_startedDateTime`,'%Y-%c-%d %T')) AS h FROM requestdata GROUP BY d,h ORDER BY d ASC
";
